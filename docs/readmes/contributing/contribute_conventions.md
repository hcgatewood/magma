...
Throughout the Magma codebase, the principal convention is the [boy scout rule](https://www.oreilly.com/library/view/97-things-every/9780596809515/ch08.html): leave it better than how you found it. Consider the following conventions when adding a PR
...
- Add tests for your changes
    ...
    - If you're not sure how to test a change, reach out on the community Slack channel for input
